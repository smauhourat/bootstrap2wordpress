        ...
        <div class="col-md-6">
          ...
          <?php
            wp_nav_menu( array(
                ...
                'menu_class'        => 'top-menu d-flex flex-row navigation top-menu justify-content-end list-unstyled', // classes of the ul tag
                'fallback_cb'       => false // if primar menu is not created, then show nothing
            ) )
          ?>
